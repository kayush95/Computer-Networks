...
int main(int argc,char* argv[])
{
     ...
     if( choice == -1)
     {
	     while(choice<1 || choice>5) 
		  {
		       cout<<"\n Please enter option 1 / 2 / 3 / 4 / 5 : \n1. Send New Email\n2. Retrieve Inbox Emails\n3. Retreive mails from both domains\n4. Send Mail to garudaserver.com\n5. Retreive mails from garudaserver.com\n\n";
          ...
          SMTP_Client* _smtp_client_4a =NULL;
          POP_Client* _pop_client_4a =NULL;
     ...
     do
     {
          ...
          switch(choice)
    	 {
            ...
            case 4:
            {
              _smtp_client_4a = new SMTP_Client("10.5.30.131",25);
              _smtp_client_4a->run_4a();
              break;
            }
            case 5:
            {
              _pop_client_4a = new POP_Client("10.5.30.131",110);
              _pop_client_4a->run_4a();
              break;
            }
